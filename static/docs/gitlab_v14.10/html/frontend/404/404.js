(function () {
      ...
      try {
        ...
        if (isArrayA && isArrayB) {
          ...
          return keysA.length === keysB.length && keysA.every(function (key) {
            return looseEqual$2(a[key], b[key])
          })
        } else {
          /* istanbul ignore next */
          return false
  ...
  function looseIndexOf (arr, val) {
    for (var i = 0; i < arr.length; i++) {
      if (looseEqual$2(arr[i], val)) { return i }
    }
    return -1
  }
  ...
  var KeepAlive = {
    ...
    mounted: function mounted () {
      ...
      this.$watch('include', function (val) {
        pruneCache(this$1$1, function (name) { return matches$1(val, name); });
      });
  ...
  var directive = {
    ...
    componentUpdated: function componentUpdated (el, binding, vnode) {
      if (vnode.tag === 'select') {
        ...
        if (curOptions.some(function (o, i) { return !looseEqual$2(o, prevOptions[i]); })) {
  ...
  function actuallySetSelected (el, binding, vm) {
    ...
    for (var i = 0, l = el.options.length; i < l; i++) {
      ...
      if (isMultiple) {
        ...
        if (looseEqual$2(getValue(option), value)) {
  ...
  function hasNoMatchingOption (value, options) {
    return options.every(function (o) { return !looseEqual$2(o, value); })
  }
  ...
  userAgent.indexOf('jsdom') > 0;
  /msie|trident/.test(userAgent); // Determine if the browser supports the option passive for events
  ...
  var cloneDeep = function cloneDeep(obj) {
    ...
    if (isPlainObject(obj)) {
      return keys(obj).reduce(function (result, key) {
        return _objectSpread$2(_objectSpread$2({}, result), {}, _defineProperty$3({}, key, cloneDeep(obj[key], obj[key])));
      }, {});
    }

    return defaultValue;
  };
  var cloneDeep$1 = cloneDeep;
  ...
  var getConfigValue = function getConfigValue(key) {
    ...
    return bvConfig ? bvConfig.getConfigValue(key, defaultValue) : cloneDeep$1(defaultValue);
  ...
  var makePropsConfigurable = function makePropsConfigurable(props, componentKey) {
    return keys(props).reduce(function (result, prop) {
      ...
      result[prop] = _objectSpread$1(_objectSpread$1({}, cloneDeep$1(currentProp)), {}, {
  ...
  w.requestAnimationFrame || w.webkitRequestAnimationFrame || w.mozRequestAnimationFrame || w.msRequestAnimationFrame || w.oRequestAnimationFrame || // Fallback, but not a true polyfill
  ...
  w.MutationObserver || w.WebKitMutationObserver || w.MozMutationObserver || null; // --- Utils ---
  ...
  var hasNormalizedSlot = function hasNormalizedSlot(names) {
    ...
    names = concat(names).filter(identity$1); // Returns true if the either a $scopedSlot or $slot exists with the specified name
  ...
  var normalizeSlot = function normalizeSlot(names) {
    ...
    // Ensure names is an array
    names = concat(names).filter(identity$1);
    var slot;
  ...
  var makePropWatcher = function makePropWatcher(propName) {
    return {
      handler: function handler(newValue, oldValue) {
        if (looseEqual$1(newValue, oldValue)) {
          return;
        }

        if (isEmpty(newValue) || isEmpty(oldValue)) {
          this[propName] = cloneDeep$1(newValue);
          return;
        }
  ...
  var makePropCacheMixin = function makePropCacheMixin(propName, proxyPropName) {
    return {
      data: function data() {
        return _defineProperty$1({}, proxyPropName, cloneDeep$1(this[propName]));
      },
      watch: _defineProperty$1({}, propName, makePropWatcher(proxyPropName))
    };
  };
  ...
  var props = makePropsConfigurable(_objectSpread(_objectSpread(_objectSpread({
    href: {
      type: String,
      default: null
    },
  ...
  var __vue_normalize__ = normalizeComponent_1;
  ...
  /* template */
  var __vue_render__$1 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('b-link',_vm._g(_vm._b({directives:[{name:"safe-link",rawName:"v-safe-link:[safeLinkConfig]",arg:_vm.safeLinkConfig}],staticClass:"gl-link",attrs:{"target":_vm.target}},'b-link',_vm.$attrs,false),_vm.$listeners),[_vm._t("default")],2)};
  ...
  var GlLink = __vue_component__$1;
  ...
  var __vue_render__ = function () {
    ...
    return _c("div", { staticClass: "d-flex justify-content-center" }, [
      _c("h2", { staticClass: "py-4" }, [
        _vm._v("There's no page at this address!"),
      ]),
      _vm._v(" "),
      _vm.isProduction && _vm.isOffline
        ? _c(
            "p",
            { staticClass: "gray js-error-description" },
            [
              _vm._v(
              ...
              _c(
                "gl-link",
                { attrs: { href: _vm.archivesPath, target: "_blank" } },
                [_vm._v("archive")]
              ),
              _vm._v(" of the older version.\n  "),
            ],
            1
          )
        : _vm._e(),
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var _document$getElementB = document.getElementById('offline-versions').dataset,
        environment = _document$getElementB.environment,
        offlineVersions = _document$getElementB.offlineVersions,
        archivesPath = _document$getElementB.archivesPath;
    var location = window.location.href;
    var isOffline = offlineVersions.split(',').find(function (version) {
      return location.includes(version);
    });
    return new Vue({
      el: '#js-error-message',
      components: {
        ErrorMessage: __vue_component__
      },
      render: function render(createElement) {
        return createElement(__vue_component__, {
          provide: {
