this["content/frontend/default/setup_table_of_contents"] = this["content/frontend/default/setup_table_of_contents"] || {};
this["content/frontend/default/setup_table_of_contents"].js = (function (exports) {
  'use strict';
  ...
  var __vue_render__$1 = function () {
    ...
    return _c(
      ...
      _vm._l(_vm.allItems, function (item, index) {
        return _c(
          "li",
          { key: item.text + "_" + index, staticClass: "mb-0" },
          [
            _c(
              "a",
              {
                staticClass: "nav-link d-block",
                class: item.levelClass,
                attrs: { id: item.id, href: item.href },
              },
              [_vm._v(_vm._s(item.text))]
            ),
            _vm._v(" "),
            item.items && item.items.length
              ? _c("table-of-contents-list", {
                  attrs: { items: item.items, level: item.level + 1 },
                })
              : _vm._e(),
          ],
          1
  ...
  var script = {
    ...
    components: {
      CollapsibleContainer: __vue_component__$2,
      TableOfContentsList: __vue_component__$1,
    },
    props: {
      items: {
        type: Array,
  ...
  var __vue_render__ = function () {
    ...
    return _c(
      "div",
      { staticClass: "markdown-toc table-of-contents-container position-sticky" },
      [
        _c(
          "div",
          { staticClass: "table-of-contents" },
          [
            _c("h4", { staticClass: "border-0 toc-sm d-xl-none" }, [
              _c(
                "a",
                {
                  staticClass: "d-flex text-decoration-none border-bottom-0",
                  attrs: {
                    href: "#",
                    role: "button",
                    "aria-expanded": !_vm.isCollapsed,
                ...
                [
                  _c("i", {
                    staticClass:
                      "fa d-flex align-items-center justify-content-center mr-1 gl-w-3",
                    class: _vm.collapseIconClass,
            ...
            _c(
              "h4",
              { staticClass: "border-0 gl-font-base font-weight-bold toc-lg" },
              [_vm._v("On this page")]
            ),
            _vm._v(" "),
            _c(
              ...
              [
                _c("table-of-contents-list", {
                  staticClass: "my-0",
                  attrs: { items: _vm.allItems, "data-testid": "main-list" },
                }),
              ],
              1
            ),
  ...
  var SIDEBAR_SELECTOR = '.doc-nav';
  var MARKDOWN_TOC_ID = 'markdown-toc';
  var HELP_AND_FEEDBACK_ID = 'help-and-feedback';
  var MAIN_SELECTOR = '.js-main-wrapper';
  var setupTableOfContents = function setupTableOfContents() {
    var sidebar = document.querySelectorAll(SIDEBAR_SELECTOR);
    var menu = document.getElementById(MARKDOWN_TOC_ID);
    var main = document.querySelector(MAIN_SELECTOR);
    var hasHelpAndFeedback = Boolean(document.getElementById(HELP_AND_FEEDBACK_ID));
    ...
    var items = parseTOC(menu);
    menu.remove();
    var el = document.createElement('div');
    return sidebar.forEach(function (sidebarEl) {
        ...
        render: function render(h) {
          return h(__vue_component__, {
            props: {
              ...
              hasHelpAndFeedback: hasHelpAndFeedback
            },
            directives: [{
  ...
  exports.setupTableOfContents = setupTableOfContents;
